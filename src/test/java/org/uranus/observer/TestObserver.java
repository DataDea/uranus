...
public class TestObserver {
    ...
    public void test() throws Exception {
        ...
        goblinTeacherEvent.setEventTime(DateUtils.parseDate("2020-04-27 23:59:59", "yyyy-MM-dd HH:mm:dd"));
        ...
        goblinStudentEvent.setEventTime(DateUtils.parseDate("2020-04-27 23:59:59", "yyyy-MM-dd HH:mm:dd"));
